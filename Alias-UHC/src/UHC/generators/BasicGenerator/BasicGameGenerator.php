...
namespace UHC\generators\BasicGenerator;
...
use UHC\generators\BasicGenerator\populator\BasicGamePopulator;
 ...
 */
class BasicGameGenerator extends VanillaGenerator{
    ...
    public function __construct(int $seed, string $preset_string){
        ...
        $this->addPopulators(new BasicGamePopulator());
    }
