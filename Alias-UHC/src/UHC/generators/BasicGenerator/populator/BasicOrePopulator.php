...
class BasicOrePopulator implements Populator{
    ...
    public function __construct(){
        ...
        $this->addOre(new OreType(VanillaBlocks::GOLD_ORE(), 0, 32, 8), 4);
        $this->addOre(new OreType(VanillaBlocks::REDSTONE_ORE(), 0, 16, 7), 8);
        $this->addOre(new OreType(VanillaBlocks::DIAMOND_ORE(), 0, 32, 7), 2);
        $this->addOre(new OreType(VanillaBlocks::LAPIS_LAZULI_ORE(), 16, 32, 6), 2);
    }
